...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-3">
            <h5>Filter TV Shows</h5>
            <form action="/tvs/filter" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="card bg-transparent" style="border: none;">
                        <a href="/tv/{{$serie['id']}}">
                            <img src="https://image.tmdb.org/t/p/w500/{{$serie['poster_path']}}" class="card-img-top" style="height: 350px;">
                        </a>
                        <div class="card-body">
                            <h5 class="card-title">{{$serie['name']}}</h5>
                            <p class="card-text">{{substr($serie['overview'], 0, 50)}}</p>
